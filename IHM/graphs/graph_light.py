...
class graph_light(pg.PlotItem):
    
    def __init__(self, parent=None, name=None, labels=None, title='Nivel de luz', viewBox=None, axisItems=None, enableMenu=True, **kargs):
        super().__init__(parent, name, labels, title, viewBox, axisItems, enableMenu, **kargs)

        self.temp_plot = self.plot(pen=(29, 255, 90))
